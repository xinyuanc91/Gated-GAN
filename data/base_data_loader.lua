...
-- |return|: a table of two tables, each corresponding to 
-- the batch for dataset A and dataset B datasetC now
function BaseDataLoader:LoadBatchForMultiStyleDatasets()
  return {},{},{},{},{},{}
end
...
function BaseDataLoader:GetNextMultiSytleBatch()
  self.data_tm:reset()
  self.data_tm:resume()
  local dataA, dataB, dataC, pathA, pathB, pathC = self:LoadBatchForMultiStyleDatasets()
  self.data_tm:stop()
  return dataA, dataB, dataC, pathA, pathB, pathC
end  
